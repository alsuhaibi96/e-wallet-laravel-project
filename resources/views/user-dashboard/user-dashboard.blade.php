...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
        ...
        <div class="navbar-wrapper bg-white">
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                                        ...
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0">
                                                    ...
                                                    <img src="{{ asset('storage/'. Auth::user()->image) }}" alt="avatar"  style="border-radius: 50%;width: 50px;height:50px" >
                                                    @else
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500">مرحبًا بك {{ Auth::user()->name }}</span> Ajeer E-Wallet  &#127881 !</h6><small class="notification-text">{{ Auth::user()->created_at }}</small>
                                            </div>
                                        </div>
                    ...
                    <span>
                        @if(isset(Auth::user()->image))
                        <img src="{{ asset('images/'. Auth::user()->image) }}"alt="users avatar" class="rounded-circle" style="width: 40px;height: 40px;"> 
                        @else
                        ...
                        @endif
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                ...
                                <div class="dropdown-divider mb-0"></div><a class="dropdown-item" href="{{ route('logout.perform'); }}" ><i class="bx bx-power-off mr-50"></i> تسجيل الخروج </a>
                            </div>
                        </li>
                    </ul>
                            ...
                            <li><a class="d-flex align-items-center" href="#"><span class="menu-item text-truncate" data-i18n="eCommerce"> رصيدك الحالي</span>  <span class="badge badge-light-success badge-pill badge-round float-right mr-50 ml-auto"> 
                                ...
                                {{-- {{Auth::user()->bank_accounts->balance.' $ '  }} </span></a> --}}
                                  ...
                                  {{-- <li class="@yield('home')"><a class="d-flex align-items-center" href="{{ route('customer_dashboard') }}"><i class="fas fa-chart-line"></i><span class="menu-item text-truncate" data-i18n="Analytics">عرض الإحصائيات</span></a>
                                    ...
                                    <li class="@yield('transfer') nav-item"><a href="#"> <i class="fas fa-exchange-alt"></i> <span class="menu-title text-truncate" data-i18n="Card">تحويل رصيد</span></a>
                                    </li>
                                    ...
                                    <li class="@yield('transfer_customer_details') nav-item"><a href="#"> <i class="fas fa-gear">  </i>  <span class="menu-title text-truncate" data-i18n="Widgets"> تقارير تحويلات الاموال</span></a>
                                    </li>
                                    <li class="@yield('settings') nav-item"><a href="#"> <i class="fas fa-gear">  </i>  <span class="menu-title text-truncate" data-i18n="Widgets">  إعدادات الحساب</span></a>
                                    </li>
                                    <li class="@yield('customer_bank_account_details') nav-item"><a href="#"> <i class="fas fa-landmark"></i> <span class="menu-title text-truncate" data-i18n="Email"> الحساب البنكي</span></a>
                                    </li>
                                    <li class=" navigation-header text-truncat divider"><span data-i18n="Forms &amp; Tables"> </span>
                                    </li>
                                    <li class="@yield('report') nav-item">
    ...
    @yield('content')
        ...
        <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0"><span class="float-left d-inline-block">2023 &copy; Ajeer Team</span><span class="float-right d-sm-inline-block d-none">Made with<i class="bx bxs-heart pink mx-50 font-small-3"></i>by<a class="text-uppercase" href="#WaslTeam.com" target="_blank"> Wasl Team</a></span>
